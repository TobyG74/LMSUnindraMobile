...
import 'pertemuan_detail_mahasiswa_screen.dart';

class PertemuanListMahasiswaScreen extends StatefulWidget {
  final String encryptedKelasId;
  final String namaMataKuliah;
  final String hari;
  final String waktu;

  const PertemuanListMahasiswaScreen({
    super.key,
  ...
  @override
  State<PertemuanListMahasiswaScreen> createState() =>
      _PertemuanListMahasiswaScreenState();
}

class _PertemuanListMahasiswaScreenState
    extends State<PertemuanListMahasiswaScreen> {
  final ApiService _apiService = ApiService();
  bool _isLoading = true;
  List<_PertemuanItem> _pertemuanList = [];
  ...
  Future<void> _loadPertemuanList() async {
    ...
    try {
      ...
      debugPrint('Error loading pertemuan list: $e');
    }
  ...
  void _parsePertemuanList(String html) {
    ...
    for (final treeview in treeviews) {
      ...
      final isMatch =
          spanText.toUpperCase().contains(widget.hari.toUpperCase()) &&
      ...
      for (final li in pertemuanItems) {
        try {
          ...
          debugPrint('Error parsing pertemuan link: $e');
        }
      }
      break;
    }
        ...
        slivers: [
          ...
          _isLoading
              ...
              : _pertemuanList.isEmpty
                  ? const SliverFillRemaining(
                      child: Center(child: Text('Belum ada pertemuan')),
                    )
                  : SliverPadding(
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                trailing: const Icon(Icons.arrow_forward_ios,
                                    size: 16),
                                onTap: () async {
                                  await _markPertemuanAsOpened(
                                    pertemuan.encryptedUrl,
                                  );
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          PertemuanDetailMahasiswaScreen(
